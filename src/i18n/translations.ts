...
export const translations = {
  fr: {
    ...
    login: {
      ...
      accountReady: 'Votre compte est prêt. Connectez-vous pour accéder à votre espace mariage.',
      accountCreatedEmailFailed: 'Votre compte a bien été créé. Si vous n’avez pas reçu d’email, utilisez la récupération de mot de passe.',
      resetUnavailable: 'La réinitialisation de mot de passe est indisponible en mode démo.',
      resetNeedEmail: 'Entrez votre email pour recevoir un lien de réinitialisation.',
      resetSent: 'Un email de réinitialisation vient d’être envoyé.',
      resetSendFailed: 'Impossible d’envoyer l’email de réinitialisation.',
      clientOnly: 'L\'espace client est réservé aux mariés. Si vous êtes invité, utilisez le code d\'accès fourni par les mariés.',
    },

    resetPassword: {
      pageTitle: 'Réinitialiser le mot de passe',
      title: 'Définissez votre nouveau mot de passe',
      subtitle: 'Choisissez un mot de passe solide pour sécuriser l’accès à votre espace mariage.',
      unavailable: 'La réinitialisation de mot de passe n’est pas disponible en mode démo.',
      openFromEmail: 'Ouvrez cette page depuis le lien reçu par email pour finaliser votre mot de passe.',
      ...
      successMessage: 'Votre mot de passe a bien été défini. Vous pouvez maintenant vous connecter à votre espace client.',
    ...
    signup: {
      ...
      checkEmail: {
        ...
        eyebrow: 'Compte prêt',
        message: 'Votre paiement a été confirmé et votre espace mariage est prêt. Nous avons envoyé un lien d’accès sécurisé à',
        fallbackEmail: 'votre adresse email',
        nextStepsTitle: 'Prochaines étapes',
        step1: 'Ouvrez l’email de Reflets de Bonheur.',
        step2: 'Utilisez le lien sécurisé pour accéder à votre tableau de bord.',
        step3: 'Terminez votre configuration: personnalisez votre site, partagez votre galerie et testez les uploads avant le mariage.',
        loginCta: 'Aller à la connexion',
      ...
      paymentStatus: {
        ...
        cancelledMessage: 'Votre paiement a été annulé. Vos informations ont été sauvegardées et vous pouvez reprendre l’achat à tout moment.',
        savedTitle: 'Éléments sauvegardés',
        savedAccount: 'Les informations de votre compte',
        savedWedding: 'Les informations de votre mariage',
        savedTheme: 'Le thème choisi',
        returnToSignup: 'Retour à l’inscription',
        backHome: 'Retour à l’accueil',
        supportLabel: 'Une question ? Contactez-nous à',
        verificationFailed: 'Échec de la vérification du paiement',
        tryAgain: 'Réessayer',
        genericError: 'Une erreur est survenue. Veuillez contacter le support.',
  ...
  en: {
    ...
    login: {
      ...
      accountReady: 'Your account is ready. Sign in to access your wedding space.',
      accountCreatedEmailFailed: 'Your account was created successfully. If you did not receive the email, use password recovery.',
      resetUnavailable: 'Password reset is unavailable in demo mode.',
      resetNeedEmail: 'Enter your email to receive a reset link.',
      resetSent: 'A password reset email has just been sent.',
      resetSendFailed: 'Unable to send the password reset email.',
      clientOnly: 'The client area is reserved for the couple. If you are a guest, use the access code shared by the couple.',
    },

    resetPassword: {
      pageTitle: 'Reset password',
      title: 'Set your new password',
      subtitle: 'Choose a strong password to secure access to your wedding space.',
      unavailable: 'Password reset is unavailable in demo mode.',
      openFromEmail: 'Open this page from the link received by email to finish setting your password.',
      ...
      successMessage: 'Your password has been set. You can now sign in to your client area.',
    ...
    signup: {
      ...
      checkEmail: {
        ...
        message: 'Your payment has been confirmed and your wedding space is ready. We sent a secure access link to',
        fallbackEmail: 'your email address',
        nextStepsTitle: 'What to do next',
        step1: 'Open the email from Reflets de Bonheur.',
        step2: 'Use the secure link to access your admin dashboard.',
        step3: 'Finish your setup: personalize your site, share your gallery link, and test uploads before the wedding.',
        loginCta: 'Go to login',
      ...
      paymentStatus: {
        ...
        cancelledMessage: 'Your payment was cancelled. Your information has been saved and you can complete your purchase anytime.',
        savedTitle: 'What\'s saved',
        savedAccount: 'Your account details',
        savedWedding: 'Your wedding information',
        savedTheme: 'Your chosen theme',
        returnToSignup: 'Return to signup',
        backHome: 'Back to home',
        supportLabel: 'Questions? Contact us at',
  ...
  es: {
    ...
    login: {
      ...
      accountReady: 'Tu cuenta está lista. Inicia sesión para acceder a tu espacio de boda.',
      accountCreatedEmailFailed: 'Tu cuenta fue creada correctamente. Si no recibiste el correo, usa la recuperación de contraseña.',
      resetUnavailable: 'La recuperación de contraseña no está disponible en modo demo.',
      resetNeedEmail: 'Ingresa tu correo electrónico para recibir un enlace de recuperación.',
      resetSent: 'Se acaba de enviar un correo para restablecer tu contraseña.',
      resetSendFailed: 'No se pudo enviar el correo de recuperación.',
      clientOnly: 'El espacio de cliente está reservado para la pareja. Si eres invitado, usa el código de acceso compartido por la pareja.',
    },

    resetPassword: {
      pageTitle: 'Restablecer contraseña',
      title: 'Define tu nueva contraseña',
      subtitle: 'Elige una contraseña segura para proteger el acceso a tu espacio de boda.',
      unavailable: 'La recuperación de contraseña no está disponible en modo demo.',
      openFromEmail: 'Abre esta página desde el enlace recibido por correo para terminar de definir tu contraseña.',
      ...
      successMessage: 'Tu contraseña ha sido definida. Ahora puedes iniciar sesión en tu espacio de cliente.',
    ...
    signup: {
      ...
      checkEmail: {
        ...
        message: 'Tu pago ha sido confirmado y tu espacio de boda está listo. Hemos enviado un enlace de acceso seguro a',
        fallbackEmail: 'tu dirección de correo',
        nextStepsTitle: 'Qué hacer ahora',
        step1: 'Abre el correo de Reflets de Bonheur.',
        step2: 'Usa el enlace seguro para acceder a tu panel de administración.',
        step3: 'Termina tu configuración: personaliza tu sitio, comparte tu galería y prueba las subidas antes de la boda.',
        loginCta: 'Ir al acceso',
      ...
      paymentStatus: {
        ...
        cancelledMessage: 'Tu pago fue cancelado. Tu información ha sido guardada y puedes completar la compra cuando quieras.',
        savedTitle: 'Información guardada',
        savedAccount: 'Los datos de tu cuenta',
        savedWedding: 'La información de tu boda',
        savedTheme: 'El tema elegido',
        returnToSignup: 'Volver al registro',
        backHome: 'Volver al inicio',
        supportLabel: '¿Preguntas? Contáctanos en',
        verificationFailed: 'La verificación del pago falló',
        tryAgain: 'Intentar de nuevo',
        genericError: 'Ocurrió un error. Por favor contacta al soporte.',
